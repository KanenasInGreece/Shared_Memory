...
# → {"status":"ok","api_version":4,"version":"0.9.62"}
...
- **Version:** `python ~/.gemini/skills/shared-memory/scripts/memory_bridge.py --version` → `{"version": "0.9.62", "api_version": 4, "tool": "shared-memory-framework"}`
