...
# Liveness:
curl http://localhost:8888/health
# → {"status":"ok","api_version":4,"version":"0.8.66","daemon":"running","rem_daemon":"running",...}
...
- **Version:** `python ~/.gemini/skills/shared-memory/scripts/memory_bridge.py --version` → `{"version": "0.8.66", "api_version": 4, "tool": "shared-memory-framework"}`
